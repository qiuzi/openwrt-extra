...
-- Obfuscation
s = m:section(TypedSection, "shadowsocks-libev", translate("Obfuscation"))
s.anonymous = true

o = s:option(ListValue, "obfs", translate("Obfuscation Method"))
...
o = s:option(Value, "protocol", translate("Obfuscation Protocol"))
