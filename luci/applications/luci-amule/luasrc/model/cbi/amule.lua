...
s:taboption("connection", DummyValue,"titlesplit1" ,"<br /><p align=\"justify\"><input type=\"button\" class=\"cbi-button cbi-button-apply\" disabled=\"true\" value=\"" .. translate("Proxy Configuration") .. "\" onclick=\"\" /></p>")
...
s:taboption("security", DummyValue,"titlesplit2" ,"<br /><p align=\"justify\"><input type=\"button\" class=\"cbi-button cbi-button-apply\" disabled=\"true\" value=\"" .. translate("IP Filter Configuration") .. "\" onclick=\"\" /></p>")
...
s:taboption("remote", DummyValue,"titlesplit3" ,"<br /><p align=\"justify\"><input type=\"button\" class=\"cbi-button cbi-button-apply\" disabled=\"true\" value=\"" .. translate("aMule Web Configuration") .. "\" onclick=\"\" /></p>")
