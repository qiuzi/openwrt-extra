...
#define HAVE_DECL_ASO_DIRECTIO_V2 0
...
/* ssize_t (*aio_write) (struct kiocb *, const struct iovec *, unsigned long,
   loff_t); */
#define HAVE_DECL_FO_AIO_WRITE_V2 0
...
/* Define to 1 if you have the declaration of `nd_set_link', and to 0 if you
   don't. */
#define HAVE_DECL_ND_SET_LINK 0
...
#define HAVE_STRUCT_FILE_OPERATIONS_AIO_READ 0

/* Define to 1 if `aio_write' is member of `struct file_operations'. */
#define HAVE_STRUCT_FILE_OPERATIONS_AIO_WRITE 0
