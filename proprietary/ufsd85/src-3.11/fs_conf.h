...
#define UFSD_HFS_ALWAYS_POSIX_TIME    // If hfs then do not convert Posix->Nt->Posix
#define UFSD_FAT_ALWAYS_POSIX_TIME    // If fat/exfat then do not convert Posix->Nt->Posix
