...
/* int blkdev_issue_zeroout(struct block_device *, sector_t, sector_t, gfp_t);
   */
#define HAVE_DECL_BLKDEV_ISSUE_ZEROOUT_V2 1

/* int blkdev_issue_zeroout(struct block_device *, sector_t, sector_t, gfp_t,
   bool); */
#define HAVE_DECL_BLKDEV_ISSUE_ZEROOUT_V3 0
...
#define HAVE_DECL_BLOCKDEV_DIRECT_IO_V4 0
...
/* Define to 1 if you have the declaration of `file_remove_privs', and to 0 if
   you don't. */
#define HAVE_DECL_FILE_REMOVE_PRIVS 0

/* void * (*follow_link) (struct dentry*, struct nameidata*); */
#define HAVE_DECL_FOLLOW_LINK_V1 0

/* const char * (*follow_link) (struct dentry *, void **); */
#define HAVE_DECL_FOLLOW_LINK_V2 0
...
#define HAVE_DECL_GENERIC_WRITE_CHECKS_V1 1

/* ssize_t generic_write_checks(struct kiocb *, struct iov_iter *); */
#define HAVE_DECL_GENERIC_WRITE_CHECKS_V2 0
...
/* Define to 1 if you have the declaration of `get_user_pages_remote', and to 0 if you
   don't. */
#define HAVE_DECL_GET_USER_PAGES_REMOTE 0
...
#define HAVE_STRUCT_INODE_OPERATIONS_GET_LINK 0
...
/* #undef HAVE_STRUCT_MODULE_MODULE_CORE */
